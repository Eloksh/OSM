...
<head>
    ...
    <title>Statistiche Donne in Età Fertile</title>
</head>
<body>
    <?php stampaNavbar(); ?>
    ...
    window.onload = function() {
        var chart = new CanvasJS.Chart("chartContainer1", {
            ...
            responsive: true,
            title: {
                text: "DONNE IN ETÀ FERTILE (da 13 a 40 anni) NELLA ZONA <?php echo strtoupper($zona) ?>",
                fontSize: 22
            },
            legend: {
                fontSize: 16
            ...
            data: [{
                ...
                dataPoints: [
                    { 
                        y: <?php echo $numero_persone_f > 0 ? (($etafertile/$numero_persone_f)*100) : 0 ?>, 
                        legendText: "<?php echo "Età fertile: ".$etafertile ?>", 
                        indexLabel: "Età fertile", 
                        color: "#E46397" 
                    }, 
                    { 
                        y: <?php echo $numero_persone_f > 0 ? (($nonfertile/$numero_persone_f)*100) : 0 ?>, 
                        legendText: "<?php echo "Non in età fertile: ".$nonfertile ?>", 
                        indexLabel: "Non in età fertile", 
                        color: "#7C6A9A" 
                    }
                ]
            }]
