...
<head>
    ...
    <title>Statistiche Maggiorenni</title>
</head>
<body>
    <?php stampaNavbar(); ?>
    ...
    <div class="container">
        ...
        // Persone minorenni per zona (minore di 18 anni = 6570 giorni)
        ...
        <div class="row mt-3">
            <div class="col-md-6 mx-auto">
                <div class="stat-info">
                    Abitanti a <?=  $zona ?> totali: <strong><?= $numero_persone ?>/<?= $tot_persone ?>  Persone <br></strong> Età media: <strong><?= (ceil($etamedia*10))/10 ?> anni</strong>
                </div>
    ...
    window.onload = function() {
        var chart = new CanvasJS.Chart("chartContainer1", {
            ...
            responsive: true,
            title: {
                text: "MAGGIORENNI E MINORENNI NELLA ZONA <?php echo strtoupper($zona) ?>",
                fontSize: 22
            },
            legend: {
                fontSize: 16
            ...
            data: [{
                ...
                dataPoints: [
                    { 
                        y: <?php echo $numero_persone > 0 ? (($maggiorenni/$numero_persone)*100) : 0 ?>, 
                        legendText: "<?php echo "Maggiorenni: ".$maggiorenni ?>", 
                        indexLabel: "Maggiorenni", 
                        color: "#5D9C59" 
                    }, 
                    { 
                        y: <?php echo $numero_persone > 0 ? (($minorenni/$numero_persone)*100) : 0 ?>, 
                        legendText: "<?php echo "Minorenni: ".$minorenni ?>", 
                        indexLabel: "Minorenni", 
                        color: "#F4CE14" 
                    }
                ]
            }]
