...
*** 13/03/2020  Carlone: modificata la query (per visualizzare anche se non c'� il capo famiglia)
...
<html>
    ...
    ?>
     ...
     <div class="search-box">
		 ...
		 $ricerca= false;
         if(isset($_POST['ricerca']))		// se � stata richiesta la ricerca, recupera la pagina da visualizzare
		   {
...
*/
  ...
  //      echo $query;
        ...
        if ($result->num_rows !=0)
        {
			...
			//nome casa  (con possibilit� di ordinamento)
            ...
            while ($row = $result->fetch_array())
            {
				...
				if (($row['id_osm'] != null) && ($row['id_osm'] != "0"))	// priorit� a id_osm
                 { 
